...
/**
 *
 * @param {org.animaltracking.AnimalMovementDeparture} movementDeparture - model instance
 * @transaction
 */
async function onAnimalMovementDeparture(movementDeparture) {  // eslint-disable-line no-unused-vars
    ...
    // save the animal
    const ar = await getAssetRegistry('org.animaltracking.Animal');
    ...
    // save the business
    const br = await getAssetRegistry('org.animaltracking.Business');
    await br.update(movementDeparture.to);
}

/**
 *
 * @param {org.animaltracking.AnimalMovementArrival} movementArrival - model instance
 * @transaction
 */
...
/**
 *
 * @param {org.animaltracking.SetupDemo} setupDemo - SetupDemo instance
 * @transaction
 */
async function setupDemo(setupDemo) {  // eslint-disable-line no-unused-vars
    const factory = getFactory();
    const NS = 'org.animaltracking';
